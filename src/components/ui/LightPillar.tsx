...
const LightPillar: React.FC<LightPillarProps> = ({
  ...
  useEffect(() => {
    ...
    const isLowEndDevice = typeof navigator !== 'undefined' && ((isMobile) || (navigator.hardwareConcurrency && navigator.hardwareConcurrency <= 4));
  ...
  }, [webGLSupported, quality, topColor, bottomColor, intensity, glowAmount, pillarWidth, pillarHeight, noiseIntensity, pillarRotation, interactive]);
